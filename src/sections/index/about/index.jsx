    ...
    <div className="about_page">
      ...
      <div className="about_team_item space-md ">
        ...
        <div className="about_desc_item_wrapper about_animate_in about_side_fade">
          <p className="about_desc_item_text  ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos
            exercitationem velit omnis dolorem corrupti sunt dolores cupiditate
            laboriosam, optio assumenda? Repellat at voluptate odit itaque
            praesentium rerum et dolores eveniet!
          </p>
          <a
            className="about_desc_item_link"
            href="mailto:gurjant@albertacommercialgroup.com"
          >
            gurjant@albertacommercialgroup.com
          </a>
          <a className="about_desc_item_link" href="tel:14036803406">
            403 680 3406
          </a>
        </div>
      </div>
      <div className="about_team_item space-md ">
        ...
        <div className="about_desc_item_wrapper right about_animate_in about_side_fade">
          <p className="about_desc_item_text  ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos
            exercitationem velit omnis dolorem corrupti sunt dolores cupiditate
            laboriosam, optio assumenda? Repellat at voluptate odit itaque
